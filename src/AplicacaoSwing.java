...
public class AplicacaoSwing {
	...
	private void initialize() {
		...
		try {
			...
			Fachada.cadastrarContato("Mauro", "mauro@mauro", "58052021", "357", "mauro", 2, 8, 24);
			Fachada.cadastrarContato("Jose", "jose@mjose", "58052546", "2", "josejose", 3, 3, 10);
			Fachada.cadastrarContato("Jair", "jair@jair", "58052123", "2", "jairjair", 3, 3, 10);
			Fachada.cadastrarContato("Romero","romero@romero","58070330","218", "romero",3,12,5);
		} catch (Exception a){
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////
																			 // PANEL ALTERAR COMPROMISSO
		
		JPanel panelAlterarCompromisso = new JPanel();
		panelAlterarCompromisso.setBorder(null);
		panelAlterarCompromisso.setBounds(10, 11, 678, 381);
		panel_1.add(panelAlterarCompromisso);
		panelAlterarCompromisso.setBackground(new Color(153, 153, 153));
		panelAlterarCompromisso.setLayout(null);
		panelAlterarCompromisso.setVisible(true);
		telas.add(panelAlterarCompromisso);
		panelAlterarCompromisso.setVisible(false);
		
		JLabel lblAlterarCompromisso = new JLabel("Alterar Compromisso");
		lblAlterarCompromisso.setOpaque(true);
		lblAlterarCompromisso.setHorizontalAlignment(SwingConstants.CENTER);
		lblAlterarCompromisso.setForeground(new Color(102, 102, 102));
		lblAlterarCompromisso.setFont(new Font("Century Gothic", Font.BOLD, 18));
		lblAlterarCompromisso.setBackground(new Color(204, 204, 204));
		lblAlterarCompromisso.setBounds(0, 0, 678, 50);
		panelAlterarCompromisso.add(lblAlterarCompromisso);
		...
		textField_20.setBounds(172, 93, 322, 30);
		panelAlterarCompromisso.add(textField_20);
		
		JFormattedTextField formattedTextField_5 = new JFormattedTextField(dataMask);
		formattedTextField_5.setForeground(Color.BLACK);
		formattedTextField_5.setFont(new Font("Century Gothic", Font.BOLD, 13));
		formattedTextField_5.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		formattedTextField_5.setBackground(new Color(204, 204, 204));
		formattedTextField_5.setBounds(172, 167, 73, 30);
		panelAlterarCompromisso.add(formattedTextField_5);
		
		JFormattedTextField formattedTextField_6 = new JFormattedTextField(horaMask);
		formattedTextField_6.setForeground(Color.BLACK);
		formattedTextField_6.setFont(new Font("Century Gothic", Font.BOLD, 13));
		formattedTextField_6.setBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null));
		formattedTextField_6.setBackground(new Color(204, 204, 204));
		formattedTextField_6.setBounds(172, 240, 66, 30);
		panelAlterarCompromisso.add(formattedTextField_6);
		...
		comboBox_4.setBounds(172, 313, 143, 30);
		panelAlterarCompromisso.add(comboBox_4);
		
		comboBox_4.setModel(model3);
		
		JButton btnAlterar_1 = new JButton("Alterar");
		btnAlterar_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					int dia = Integer.parseInt(formattedTextField_5.getText().substring(0, 2));
					int mes = Integer.parseInt(formattedTextField_5.getText().substring(3, 5));
					int ano = Integer.parseInt(formattedTextField_5.getText().substring(6));
					Fachada.alterarDataCompromisso(textField_20.getText(),LocalDate.of(ano,mes,dia));
					JOptionPane.showMessageDialog(null,"Data alterado com sucesso!","Alterar Compromisso", JOptionPane.INFORMATION_MESSAGE);
				} catch (Exception a) {
					JOptionPane.showMessageDialog(null,a.getMessage(),"Alterar Compromisso", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
		btnAlterar_1.setForeground(Color.WHITE);
		btnAlterar_1.setFont(new Font("Century Gothic", Font.BOLD, 14));
		btnAlterar_1.setBorder(new MatteBorder(1, 1, 2, 3, (Color) new Color(255, 255, 255)));
		btnAlterar_1.setBackground(new Color(102, 102, 102));
		btnAlterar_1.setBounds(366, 167, 128, 30);
		panelAlterarCompromisso.add(btnAlterar_1);
		
		JLabel label = new JLabel("T\u00EDtulo:");
		label.setForeground(Color.WHITE);
		label.setFont(new Font("Century Gothic", Font.BOLD, 14));
		label.setBounds(172, 61, 75, 20);
		panelAlterarCompromisso.add(label);
		
		JLabel label_13 = new JLabel("Data:");
		label_13.setForeground(Color.WHITE);
		label_13.setFont(new Font("Century Gothic", Font.BOLD, 14));
		label_13.setBounds(172, 135, 75, 20);
		panelAlterarCompromisso.add(label_13);
		
		JLabel label_14 = new JLabel("Hora:");
		label_14.setForeground(Color.WHITE);
		label_14.setFont(new Font("Century Gothic", Font.BOLD, 14));
		label_14.setBounds(172, 208, 75, 20);
		panelAlterarCompromisso.add(label_14);
		
		JLabel label_15 = new JLabel("Tipo:");
		label_15.setForeground(Color.WHITE);
		label_15.setFont(new Font("Century Gothic", Font.BOLD, 14));
		label_15.setBounds(172, 281, 75, 20);
		panelAlterarCompromisso.add(label_15);
		
		JButton btnAlterar_3 = new JButton("Alterar");
		btnAlterar_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Fachada.alterarTipoCompromisso(textField_20.getText(),comboBox_4.getSelectedItem().toString());
					JOptionPane.showMessageDialog(null,"Tipo alterado com sucesso!","Alterar Compromisso", JOptionPane.INFORMATION_MESSAGE);
				} catch (Exception a) {
					JOptionPane.showMessageDialog(null,a.getMessage(),"Alterar Compromisso", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
		btnAlterar_3.setForeground(Color.WHITE);
		btnAlterar_3.setFont(new Font("Century Gothic", Font.BOLD, 14));
		btnAlterar_3.setBorder(new MatteBorder(1, 1, 2, 3, (Color) new Color(255, 255, 255)));
		btnAlterar_3.setBackground(new Color(102, 102, 102));
		btnAlterar_3.setBounds(366, 312, 128, 30);
		panelAlterarCompromisso.add(btnAlterar_3);
		
		JButton btnAlterar_2 = new JButton("Alterar");
		btnAlterar_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					int hora = Integer.parseInt(formattedTextField_6.getText().substring(0, 2));
					int minuto = Integer.parseInt(formattedTextField_6.getText().substring(3));
					Fachada.alterarHoraCompromisso(textField_20.getText(),LocalTime.of(hora,minuto));
					JOptionPane.showMessageDialog(null,"Hora alterado com sucesso!","Alterar Compromisso", JOptionPane.INFORMATION_MESSAGE);
				} catch (Exception a) {
					JOptionPane.showMessageDialog(null,a.getMessage(),"Alterar Compromisso", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		});
		btnAlterar_2.setForeground(Color.WHITE);
		btnAlterar_2.setFont(new Font("Century Gothic", Font.BOLD, 14));
		btnAlterar_2.setBorder(new MatteBorder(1, 1, 2, 3, (Color) new Color(255, 255, 255)));
		btnAlterar_2.setBackground(new Color(102, 102, 102));
		btnAlterar_2.setBounds(366, 240, 128, 30);
		panelAlterarCompromisso.add(btnAlterar_2);
		...
		lblMauricioPereira.setBounds(12, 257, 293, 112);
		...
		lblNewLabel.setBounds(12, 12, 293, 233);
		...
		lblContatos.setBounds(317, 12, 349, 112);
		...
		lblCompromissos.setBounds(317, 257, 349, 112);
		...
		lblTelefones.setBounds(317, 136, 349, 109);
			...
			public void actionPerformed(ActionEvent e) {
				try{
					...
					for(Contato c: lista) {
						...
						lblNewLabel_1.setSize(235, 69);
						lblNewLabel_1.setOpaque(true);
						lblNewLabel_1.setLayout(null);
						
						JLabel lblNewLabel_2 = new JLabel(c.getNome().substring(0,1).toUpperCase());
						...
						lblNewLabel_2.setBounds(10, 11, 47, 47);
						lblNewLabel_2.setOpaque(true);
						lblNewLabel_1.add(lblNewLabel_2);
						
						JLabel label_16 = new JLabel(c.getNome());
						label_16.setOpaque(true);
						label_16.setHorizontalAlignment(SwingConstants.CENTER);
						label_16.setForeground(Color.WHITE);
						label_16.setFont(new Font("Century Gothic", Font.BOLD, 12));
						label_16.setBackground(new Color(255, 153, 51));
						label_16.setBounds(67, 11, 158, 19);
						lblNewLabel_1.add(label_16);
						
						JLabel label_17 = new JLabel(c.getEndereco() + " - " + c.getNumero());
						label_17.setOpaque(true);
						label_17.setHorizontalAlignment(SwingConstants.CENTER);
						label_17.setForeground(Color.WHITE);
						label_17.setFont(new Font("Century Gothic", Font.BOLD, 12));
						label_17.setBackground(new Color(255, 153, 51));
						label_17.setBounds(67, 39, 158, 19);
						lblNewLabel_1.add(label_17);
...
//						}
						...
						model.addElement(lblNewLabel_1);
						//model.addElement(texto);
						//texto +=  c + "\n----\n";
					}
...
//		panelRemoverContato.add(lblRemoverContato);
		...
		JMenuItem mntmAdicionarCompromisso = new JMenuItem("Adicionar Compromisso");
		...
		JMenuItem mntmAlterarCompromisso = new JMenuItem("Alterar Compromisso");
		mntmAlterarCompromisso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				evidenciarPanel(panelAlterarCompromisso);
				evidenciarMenu(mnCompromissos);
			}
		});
		mntmAlterarCompromisso.setHorizontalAlignment(SwingConstants.LEFT);
		mntmAlterarCompromisso.setForeground(new Color(102, 102, 102));
		mntmAlterarCompromisso.setFont(new Font("Century Gothic", Font.BOLD, 14));
		mntmAlterarCompromisso.setBackground(Color.WHITE);
		mnCompromissos.add(mntmAlterarCompromisso);
	...
	public void pesquisaMaps(String endereco, String numero) throws Exception {
